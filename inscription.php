...
{
    debug($_POST);
    $verif_caractere = preg_match('#^[a-zA-Z0-9._-]+$#', filter_input($_POST['pseudo']));
...
<form action="" method="POST">
    ...
    <input type="text" id="pseudo" name="pseudo" maxlength="20" placeholder="votre pseudo"
           pattern="[a-zA-Z0-9-_.]{1,20}" title="caractères acceptés : a-zA-Z0-9-_." required="required"> <br>
<br>
...
pattern="[a-zA-Z0-9-_.]{5,15}" title="caractères acceptés : a-zA-Z0-9-_."><br><br>
